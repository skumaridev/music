$(document).ready(function() {
    ...
    var TITLE = 'Loudness and Tempo for Top 5 Strems in North America, 2021-22';
  
    var POINT_X = 'streams'; // column name for x values in data.csv
    var POINT_X_PREFIX = '$'; // prefix for x values, eg '$'
    var POINT_X_POSTFIX = ''; // postfix for x values, eg '%'
  
    var POINT_Y = 'loudness'; // column name for y values in data.csv
    var POINT_Y_PREFIX = ''; // prefix for x values, eg 'USD '
    var POINT_Y_POSTFIX = ''; // postfix for x values, eg ' kg'
  
    var POINT_R = 'tempo'; // column name for radius in data.csv
    ...
    var X_AXIS = 'Total number of Streams'; // x-axis label, label in tooltip
    var Y_AXIS = 'Loudness'; // y-axis label, label in tooltip
  
    var SHOW_GRID = true; // `true` to show the grid, `false` to hide
  
    // Read data file with random string generated by current time
    // to bypass browser cache, and create chart
    $.get('https://raw.githubusercontent.com/skumaridev/music/main/bubble.csv', {'_': $.now()}, function(csvString) {
